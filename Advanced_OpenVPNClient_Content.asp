...
<td colspan="5">Rules for routing client traffic through the tunnel (<#2001#>&nbsp;100)  Patched by Martineau v2.01   <!-- Martineau Hack --></td>
<!-- Martineau Hack ############################################################################-->
</tr>
</thead>
<tr>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullIPSETLANIPList(this);" title="<#2410#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
<div id="ClientList_Block_PC" class="ClientList_Block_PC"></div>
</td>
<td width="12%">
