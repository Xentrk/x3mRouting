...
SELECTIVE_ROUTING_DIR="/jffs/scripts/$GIT_REPO"
TORGUARD="https://x3mtek.com/why-i-use-torguard-as-my-vpn-provider/"
TORGUARD_CONFIG="https://x3mtek.com/torguard-openvpn-2-4-client-setup-for-asuswrt-merlin-firmware/"
...
while [ "$loop_count" -le "$static_leases_count" ]
do
